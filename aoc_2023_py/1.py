...
def get_first_and_last_digit(file_line: str):
    pass
...
if __name__ == "__main__":
    parse_input()
    #sum_calibration_values = sum_numbers()
    #print(f"the sum of all of the calibration numbers is: {sum_calibration_values}")
