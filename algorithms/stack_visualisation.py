...
func_param_1_mem_block = MemBlock(None, None, 'Function (Add) Variable 1', 0.2, 9, 0.3, 0.6, 1, 0.5, 9.7)
...
func_param_2_mem_block = MemBlock(None, None, 'Function (Add) Variable 2', 0.2, 11, 1.6, 0.6, 1, 0.5, 11.7)
func_param_2_mem_block.create_rect()
ani_2 = FuncAnimation(fig, func_param_2_mem_block.update, frames=range(101), interval=60)
